...
execute if score doors tardis1 matches 1.. run tag @e[tag=intdoor1] add intopen1
execute if score doors tardis1 matches 0 run tag @e[tag=intdoor1] remove intopen1
