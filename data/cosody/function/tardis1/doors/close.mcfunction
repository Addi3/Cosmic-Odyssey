...
execute if score chamelion tardis1 matches 2 if score doors tardis1 matches 0 at @e[tag=tardis1] run playsound minecraft:tardis_door_close ambient @a[distance=..8] ~ ~ ~ 1.8 1 1
execute if score chamelion tardis1 matches 2 if score doors tardis1 matches 0 at @e[tag=intdoor] run playsound minecraft:tardis_door_close ambient @a[distance=..8] ~ ~ ~ 1.8 1 1
