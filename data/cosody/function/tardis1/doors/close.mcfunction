...
execute if score chamelion tardis1 matches 1 if score doors tardis1 matches 0 at @e[tag=intdoor] run playsound minecraft:tt_capsule_door ambient @a[distance=..8] ~ ~ ~ 1.8 1 1
...
execute if score chamelion tardis1 matches 2 if score doors tardis1 matches 0 run item replace entity @e[tag=intdoor] armor.head with minecraft:cyan_dye[custom_model_data=3]

execute if score chamelion tardis1 matches 2 if score doors tardis1 matches 0 at @e[tag=tardis1] run playsound minecraft:tardis_door_close ambient @a[distance=..8] ~ ~ ~ 1.4 1 1
execute if score chamelion tardis1 matches 2 if score doors tardis1 matches 0 at @e[tag=intdoor] run playsound minecraft:tardis_door_close ambient @a[distance=..8] ~ ~ ~ 1.4 1 1
...
execute if score chamelion tardis1 matches 3 if score doors tardis1 matches 0 run item replace entity @e[tag=intdoor] armor.head with minecraft:red_dye[custom_model_data=3]
...
execute if score chamelion tardis1 matches 3 if score doors tardis1 matches 0 at @e[tag=intdoor] run playsound minecraft:block.copper_door.close ambient @a[distance=..8] ~ ~ ~ 1.8 1 1
