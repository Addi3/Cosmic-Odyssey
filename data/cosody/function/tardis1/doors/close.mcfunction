...
execute if score chamelion tardis1 matches 2 if score doors tardis1 matches 0 at @e[tag=intdoor] run playsound minecraft:tardis_door_close ambient @a[distance=..8] ~ ~ ~ .6 1 1
