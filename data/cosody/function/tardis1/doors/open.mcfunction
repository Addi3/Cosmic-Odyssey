...
execute if score chamelion tardis1 matches 1 if score doors tardis1 matches 2 at @e[tag=tardis1] run playsound minecraft:tt_capsule_door ambient @a[distance=..8] ~ ~ ~ 1 1 1
execute if score chamelion tardis1 matches 1 if score doors tardis1 matches 2 at @e[tag=intdoor1] run playsound minecraft:tt_capsule_door ambient @a[distance=..8] ~ ~ ~ 1 1 1
...
execute if score chamelion tardis1 matches 2 if score doors tardis1 matches 1 at @e[tag=intdoor1] run playsound minecraft:tardis_door_open ambient @a[distance=..8] ~ ~ ~ .6 1 1
...
execute if score chamelion tardis1 matches 3 if score doors tardis1 matches 1 at @e[tag=tardis1] run playsound minecraft:block.copper_door.open ambient @a[distance=..8] ~ ~ ~ 1 1 1
execute if score chamelion tardis1 matches 3 if score doors tardis1 matches 1 at @e[tag=intdoor1] run playsound minecraft:block.copper_door.open ambient @a[distance=..8] ~ ~ ~ 1 1 1
...
execute if score chamelion tardis1 matches 4 if score doors tardis1 matches 1 at @e[tag=tardis1] run playsound minecraft:block.wooden_door.open ambient @a[distance=..8] ~ ~ ~ 1 1 1
execute if score chamelion tardis1 matches 4 if score doors tardis1 matches 1 at @e[tag=intdoor1] run playsound minecraft:block.wooden_door.open ambient @a[distance=..8] ~ ~ ~ 1 1 1
...
execute if score chamelion tardis1 matches 5 if score doors tardis1 matches 1 at @e[tag=tardis1] run playsound minecraft:police_box_open ambient @a[distance=..8] ~ ~ ~ 1 1 1
execute if score chamelion tardis1 matches 5 if score doors tardis1 matches 1 at @e[tag=intdoor1] run playsound minecraft:police_box_open ambient @a[distance=..8] ~ ~ ~ 1 1 1
execute if score chamelion tardis1 matches 5 if score doors tardis1 matches 2 at @e[tag=tardis1] run playsound minecraft:police_box_open ambient @a[distance=..8] ~ ~ ~ 1 1 1
execute if score chamelion tardis1 matches 5 if score doors tardis1 matches 2 at @e[tag=intdoor1] run playsound minecraft:police_box_open ambient @a[distance=..8] ~ ~ ~ 1 1 1
