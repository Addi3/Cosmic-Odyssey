...
execute at @e[tag=open1] run playsound minecraft:ship_ambience2 ambient @p[distance=..4] ~ ~ ~ .5 1 1
...
execute if score chamelion tardis1 matches 1 if score doors tardis1 matches 2 at @e[tag=intdoor1] run playsound minecraft:tt_capsule_door ambient @a[distance=..8] ~ ~ ~ 1.8 1 1
...
execute if score chamelion tardis1 matches 3 if score doors tardis1 matches 1 at @e[tag=intdoor1] run playsound minecraft:block.copper_door.open ambient @a[distance=..8] ~ ~ ~ 1.8 1 1
