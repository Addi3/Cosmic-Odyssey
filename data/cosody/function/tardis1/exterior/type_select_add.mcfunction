scoreboard players add chameliontype tardis1 1
...
#Capsules
execute if score chamelionNo tardis1 matches 1 if score chameliontype tardis1 matches 2 run scoreboard players set chameliontype tardis1 1

#PhoneBooths
execute if score chamelionNo tardis1 matches 2 if score chameliontype tardis1 matches 2 run scoreboard players set chameliontype tardis1 1

#Policeboxs
execute if score chamelionNo tardis1 matches 3 if score chameliontype tardis1 matches 4 run scoreboard players set chameliontype tardis1 1
