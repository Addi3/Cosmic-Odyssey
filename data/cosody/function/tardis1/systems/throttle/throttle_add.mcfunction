...
execute if score vortexspeed tardis1 matches 0 at @e[tag=console1] if entity @e[tag=inside1,distance=..5] run playsound minecraft:throttledown ambient @p[tag=inside1] ~ ~ ~ 1 .9 1
...
scoreboard players add vortexspeed tardis1 1
