...
execute if score vortexspeed tardis1 matches 1 if score is_landed tardis1 matches 1 if score geartimer tardis1 matches 1 at @e[tag=tardis1] if entity @p[distance=..5] run playsound minecraft:time_rotor ambient @p ~ ~ ~ 1 1 1
execute if score vortexspeed tardis1 matches 1 if score is_landed tardis1 matches 1 if score geartimer tardis1 matches 35 at @e[tag=tardis1] if entity @p[distance=..5] run playsound minecraft:time_rotor ambient @p ~ ~ ~ 1 1 1
execute if score vortexspeed tardis1 matches 2 if score is_landed tardis1 matches 1 if score geartimer tardis1 matches 1 at @e[tag=tardis1] if entity @p[distance=..5] run playsound minecraft:time_rotor ambient @p ~ ~ ~ 1 1.1 1
execute if score vortexspeed tardis1 matches 2 if score is_landed tardis1 matches 1 if score geartimer tardis1 matches 32 at @e[tag=tardis1] if entity @p[distance=..5] run playsound minecraft:time_rotor ambient @p ~ ~ ~ 1 1.1 1
execute if score vortexspeed tardis1 matches 3 if score is_landed tardis1 matches 1 if score geartimer tardis1 matches 1 at @e[tag=tardis1] if entity @p[distance=..5] run playsound minecraft:time_rotor ambient @p ~ ~ ~ 1 1.17 1
execute if score vortexspeed tardis1 matches 3 if score is_landed tardis1 matches 1 if score geartimer tardis1 matches 30 at @e[tag=tardis1] if entity @p[distance=..5] run playsound minecraft:time_rotor ambient @p ~ ~ ~ 1. 1.17 1
