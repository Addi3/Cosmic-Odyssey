...
execute if score chamelion tardis1 matches 1 run item replace entity @e[tag=intdoor1] armor.head with minecraft:light_gray_dye[custom_model_data=4]
...
execute if score chamelion tardis1 matches 2 run item replace entity @e[tag=intdoor1] armor.head with minecraft:cyan_dye[custom_model_data=3]
...
execute if score chamelion tardis1 matches 2 at @e[tag=intdoor1] run playsound minecraft:tardis_door_close ambient @a[distance=..8] ~ ~ ~ 1.4 1 1
...
execute if score chamelion tardis1 matches 3 run item replace entity @e[tag=intdoor1] armor.head with minecraft:red_dye[custom_model_data=3]
