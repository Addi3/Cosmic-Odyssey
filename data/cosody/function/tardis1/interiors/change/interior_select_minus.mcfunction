...
execute if score interior tardis1 matches ..-1 run scoreboard players set interior tardis1 5
...
#execute if score interior tardis1 matches 6 run title @p actionbar {"bold":true,"color":"gold","text":"Toyota"}
