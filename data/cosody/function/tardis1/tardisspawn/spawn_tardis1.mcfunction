...
execute at @e[tag=tardis1spawnmarker] run summon armor_stand ~ ~50 ~ {Invulnerable:1b,ShowArms:1b,Invisible:1b,Tags:["tardis1"],Pose:{RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:soul_torch",count:1},{}],ArmorItems:[{},{},{},{id:"minecraft:light_gray_dye",count:1,components:{"minecraft:custom_model_data":1}}]}
