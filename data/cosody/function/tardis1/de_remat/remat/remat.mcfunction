...
execute if score remat_anim_timer tardis1 matches 337 run item replace entity @e[tag=tardis1v] weapon.offhand with minecraft:soul_torch[custom_model_data=1]
